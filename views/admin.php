...
<body>
    ...
    <div class="container">
        ...
        <p>Halaman Dimana Admin Menginput Data Berat Sampah</p>
        <p>Yang Akan Otomatis Berubah Menjadi Point Untuk User</p>

        <h2>Pilih Kategori Sampah</h2>
        <div class="categories">
            <div class="card" onclick="openModal('Plastik')">
                <img src="../assets/gambarkategori/plastik.png" alt="Sampah Plastik">
                <p>Sampah Plastik</p>
            </div>
            <div class="card" onclick="openModal('Kaleng')">
                <img src="../assets/gambarkategori/kaleng.png" alt="Sampah Kaleng">
                <p>Sampah Kaleng</p>
            </div>
            <div class="card" onclick="openModal('Kaca')">
                <img src="../assets/gambarkategori/kaca.png" alt="Sampah Kaca">
                <p>Sampah Kaca</p>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form id="data-form">
                    ...
                    <div class="form-group">
                        <label>User</label>
                        <input type="text" id="search" placeholder="Cari nama atau email" autocomplete="off" onkeyup="searchUser()">
